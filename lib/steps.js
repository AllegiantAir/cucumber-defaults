...
exports.Steps = function() {
    ...
    this.Then(/^I should see "([^"]*)" and "([^"]*)" in the same "([^"]*)" element$/, function(textOne, textTwo, element, callback) {
        mapSteps.shouldFindBothInTheSameRow(textOne, textTwo, element, this, callback).then(
            function resolve() {
                callback();
            },
            function reject(err) {
    ...
    this.Then(/^I should see "([^"]*)" and "([^"]*)" in the same table row$/, function(textOne, textTwo, callback) {
        mapSteps.shouldFindBothInTheSameRow(textOne, textTwo, 'tr', this, callback).then(
            function resolve() {
                callback();
            },
            function reject(err) {
    ...
    this.Then(/^I should see "([^"]*)" and "([^"]*)" in the same li$/, function(textOne, textTwo, callback) {
        mapSteps.shouldFindBothInTheSameRow(textOne, textTwo, 'li', this, callback).then(
            function resolve() {
                callback();
            },
            function reject(err) {
